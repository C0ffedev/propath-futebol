  ...
  UI.hubDashboard = function(){
    ...
    return `<div class="panel hub-dash">
      <div class="hub-player">
        ...
        <div class="hp-stam"><div class="hp-stam-fill ${(typeof S.stamina==="number"?S.stamina:100)<40?"crit":((typeof S.stamina==="number"?S.stamina:100)<70?"warn":"ok")}" style="width:${(typeof S.stamina==="number"?S.stamina:100)}%"></div></div>
